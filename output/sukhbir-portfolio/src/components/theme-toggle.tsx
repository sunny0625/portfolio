...
export function ThemeToggle() {
  ...
  return (
    <button aria-label="Toggle theme" onClick={() => setTheme(isDark ? 'light' : 'dark')} className="relative flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5 text-foreground/90 backdrop-blur transition duration-300 hover:scale-105 hover:border-blue-400/40 hover:shadow-glow">
