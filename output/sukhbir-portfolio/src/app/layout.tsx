...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Sukhbir Singh | DevOps Engineer Portfolio', description: 'Building scalable systems, automating workflows, and deploying innovation.', type: 'website' }
}
